...
5. call sentenceNormalizer.makeTable(filename, floor, ceiling) to create a hash table of the words in your txt file that are indexed by length.
...
6. Then call sentenceNormalizer.spellCorrected(hashtable, string you want to be corrected ) and the ouput will be the corrected/normalized sentence. 